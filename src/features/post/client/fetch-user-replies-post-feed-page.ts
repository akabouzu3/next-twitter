...
export async function fetchUserRepliesPostFeedPageByUsername({
  ...
  const res = await fetch(`/api/posts/${username}/replies?${params.toString()}`, {
    method: "GET",
    cache: "no-store",
    signal,
  });
